...
if(__name__ == '__main__'):
    ...
    print(f'Re = {Reynolds(0.001, 0.3):.2f} for U = 0.001 m/s')
    print(f'Re = {Reynolds(0.01, 0.3):.2f} for U = 0.01 m/s')
    print(f'Re = {Reynolds(0.1, 0.3):.2f} for U = 0.1 m/s')
    print(f'Re = {Reynolds(1, 0.3):.2f} for U = 1 m/s')
    print(22000*viscosity/0.3)
    print(f'Re = {Reynolds(10, 0.3):.2f} for U = 10 m/s')
    print(f'Re = {Reynolds(5, 0.3):.2f} for U = 5 m/s')